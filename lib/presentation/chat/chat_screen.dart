...
// When embedInParent: Column only (no [Scaffold]/[AppBar]) for use inside home tabs.
// Otherwise: Scaffold
//   └─ Column
//        ├─ Expanded → ListView (mock chat rows)
//        ├─ if slashMode: SlashPromptPickerOverlay
//        └─ SafeArea → Material → Row [ TextField, send ]
