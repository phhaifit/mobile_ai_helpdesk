...
class TemplateLibraryScreen extends StatefulWidget {
  ...
  const TemplateLibraryScreen({super.key, this.showAppBar = true, this.onMenuTap});
...
class _TemplateLibraryScreenState extends State<TemplateLibraryScreen> {
  ...
  void initState() {
    ...
    _searchController.addListener(() => _store.setTemplateSearchQuery(_searchController.text));
  }
        ...
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                const Text('Tên template', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                ...
                const Text('Nền tảng', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                const SizedBox(height: 6),
                DropdownButtonFormField<CampaignChannel>(
                  ...
                  items: [
                    DropdownMenuItem(
                      ...
                      child: Row(children: [
                        Icon(Icons.chat_bubble_outline, size: 16, color: _channelColor(CampaignChannel.messenger)),
                        const SizedBox(width: 8),
                        Text(l.translate('marketing_tv_channel_messenger')),
                      ]),
                    ),
                    DropdownMenuItem(
                      value: CampaignChannel.zalo,
                      child: Row(children: [
                        Icon(Icons.message_outlined, size: 16, color: _channelColor(CampaignChannel.zalo)),
                        const SizedBox(width: 8),
                    ...
                    DropdownMenuItem(
                      ...
                      child: Row(children: [
                        Icon(Icons.email_outlined, size: 16, color: _channelColor(CampaignChannel.email)),
                        const SizedBox(width: 8),
                    ...
                    DropdownMenuItem(
                      ...
                      child: Row(children: [
                        Icon(Icons.sms_outlined, size: 16, color: _channelColor(CampaignChannel.sms)),
                        const SizedBox(width: 8),
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                ...
                Navigator.pushNamed(context, Routes.templateCreateEdit)
    ...
    return Observer(
      builder: (_) => TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: _store.templateSearchQuery.isNotEmpty
              ? IconButton(
        ...
        child: Row(
          children: [
            ...
            _PlatformChip(
              ...
              selected: _store.draftChannelFilter == CampaignChannel.messenger,
              onTap: () {
                if (_store.draftChannelFilter == CampaignChannel.messenger) {
    ...
    return Observer(
      builder: (_) {
        ...
        if (_store.draftChannelFilter != null) {
          templates = templates.where((t) => t.channel == _store.draftChannelFilter).toList();
        }
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.article_outlined, size: 40, color: AppColors.messengerBlue.withValues(alpha: 0.5)),
                ),
                const SizedBox(height: 16),
                Text(l.translate('marketing_tv_empty_templates'),
  ...
  Widget _buildTemplateCard(BuildContext context, MarketingTemplate t, AppLocalizations l) {
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => [
                    const PopupMenuItem(value: 'edit', child: Row(children: [
                      Icon(Icons.edit_outlined, size: 16), SizedBox(width: 8), Text('Chỉnh sửa'),
                    ])),
                    const PopupMenuItem(value: 'delete', child: Row(children: [
                      Icon(Icons.delete_outlined, size: 16, color: Colors.red), SizedBox(width: 8),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(channelLabel, style: TextStyle(fontSize: 11, color: channelColor, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
          ),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text('XEM TRƯỚC', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: Color(0xFF9CA3AF), letterSpacing: 0.5)),
                    ),
                    Expanded(
                      child: Padding(
  ...
  void _confirmDelete(BuildContext ctx, MarketingTemplate t, AppLocalizations l) {
    showDialog(
      context: ctx,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 14, color: selected ? color : const Color(0xFF6B7280)),
