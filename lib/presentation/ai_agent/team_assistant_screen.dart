...
class _TeamAssistantScreenState extends State<TeamAssistantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.translate('ai_agent_team_assistant_title'))),
      body: Observer(
        builder: (_) {
          if (_store.isLoading) {
          ...
          return Column(
            children: [
              ...
              Expanded(
                child:
                    _store.agents.isEmpty
                        ? Center(child: Text(l.translate('ai_agent_no_agents')))
                        : ListView.builder(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return RadioListTile<String>(
                              ...
                              onChanged:
                                  (id) => setState(() => _selectedAgentId = id),
