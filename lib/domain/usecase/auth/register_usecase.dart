...
class RegisterUseCase extends UseCase<Either<Failure, AuthResponse>, RegisterRequest> {
  final AuthRepository _repository;

  RegisterUseCase(this._repository);

  @override
  Future<Either<Failure, AuthResponse>> call({required RegisterRequest params}) async {
    ...
    if (!_isPasswordStrong(params.password)) {
      return const Left(ValidationFailure('Password must be at least 8 characters with uppercase, lowercase, number and special character'));
    }
