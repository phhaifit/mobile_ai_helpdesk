...
class ResumeCampaignUseCase extends UseCase<CampaignActionResult, CampaignIdParams> {
  final MarketingRepository _repository;

  ResumeCampaignUseCase(this._repository);

  @override
  Future<CampaignActionResult> call({required CampaignIdParams params}) {
    return _repository.resumeCampaign(params.id);
  }
}
