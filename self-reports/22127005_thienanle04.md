...
|---|---|---|---|---|---|---|---|---|
| 1 | [#5](https://github.com/phhaifit/mobile_ai_helpdesk/issues/5) | Tenant Management | 10 | _solo_ | _100%_ | 10 | [#44](https://github.com/phhaifit/mobile_ai_helpdesk/pull/44) | https://youtu.be/jrZUO9mZvAE |
| 2 | #__ |  |  |  |  |  |  |  |
| 3 | #__ |  |  |  |  |  |  |  |
...
|---|---|---|---|---|---|---|---|---|
| 1 | [#55](https://github.com/phhaifit/mobile_ai_helpdesk/issues/55) | [Full-integration] Real-time Messaging | 18 | _solo_ | 100% | 18 | [#107](https://github.com/phhaifit/mobile_ai_helpdesk/pull/107) | https://youtu.be/_mGP9rVaAM8 |
| 2 |  |  |  |  |  |  |  |  |
...
Chủ động nghiên cứu các response và payload của các API Endpoints.

### Khó khăn bạn gặp phải:

API docs và backend không đồng bộ. DTO mỗi channel khác nhau dẫn đến việc khó khăn khi parse dữ liệu về domain entity.

### Bạn sẽ làm khác đi điều gì nếu được làm lại:

Trao đổi nhiều hơn với team backend về các APIs.
